...
global.channelLink = "https://whatsapp.com/channel/0029VbCkm3rAe5VzCYLtNb2u";
global.ytch = "TeamRedXhackers";
        ...
        switch (true) {
          ...
          case userMessage.startsWith('.fetchapi'):
            ...
            case userMessage.startsWith('.mediafire'):
                ...
                commandExecuted = true;
                break;
            case userMessage.startsWith('.searchimg'):
                await searchimgCommand(sock, chatId, message);
                commandExecuted = true;
                break;
